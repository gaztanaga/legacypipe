...
def match_distance(dist,savefig=False):
...
def nonzero_flux_errbars(matched1,matched2,\
...
def nonzero_fluxdeltaflux(matched1,matched2,\
                         ref_name='ref',obs_name='obs',savefig=False):
    fig,ax= plt.subplots(1,3)
    for cnt,iband,band,cc in [(0,1,'g','g'),(1,2,'r','r'),(2,4,'z','m')]:
...
def grz_ratio_fluxerr(matched1,matched2,\
                      ref_name='ref',obs_name='obs',savefig=False):
    fig,ax= plt.subplots(1,3)
    lp,lt = [],[]
    for cnt,iband,band,cc in [(0,1,'g','g'),(1,2,'r','r'),(2,4,'z','m')]:
...
def magdeltamag(matched1,matched2,\
          ref_name='ref',obs_name='obs',savefig=False):
    fig,ax= plt.subplots(1,3)
    for cnt,iband,band,cc in [(0,1,'g','g'),(1,2,'r','r'),(2,4,'z','m')]:
        mag1, magerr1 = NanoMaggies.fluxErrorsToMagErrors(
...
def deltamag_err(matched1,matched2,\
          ref_name='ref',obs_name='obs',savefig=False):
    fig,ax= plt.subplots(1,3)
    for cnt,iband,band,cc in [(0,1,'g','g'),(1,2,'r','r'),(2,4,'z','m')]:
        mag1, magerr1 = NanoMaggies.fluxErrorsToMagErrors(
...
def deltamag_errbars(matched1,matched2,\
          ref_name='ref',obs_name='obs',savefig=False):
    fig,ax= plt.subplots(1,3)
    for cnt,iband,band,cc in [(0,1,'g','g'),(1,2,'r','r'),(2,4,'z','m')]:
        mag1, magerr1 = NanoMaggies.fluxErrorsToMagErrors(
...
def stephist(matched1,matched2,\
          ref_name='ref',obs_name='obs',savefig=False):
    fig,ax= plt.subplots(1,3)
    for cnt,iband,band,cc in [(0,1,'g','g'),(1,2,'r','r'),(2,4,'z','m')]:
        mag1, magerr1 = NanoMaggies.fluxErrorsToMagErrors(
...
def curvehist(matched1,matched2,\
          ref_name='ref',obs_name='obs',savefig=False):
    fig,ax= plt.subplots(1,3)
    for cnt,iband,band,cc in [(0,1,'g','g'),(1,2,'r','r'),(2,4,'z','m')]:
        mag1, magerr1 = NanoMaggies.fluxErrorsToMagErrors(
