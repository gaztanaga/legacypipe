...
did_bcast=yes
outdir=$SCRATCH/dr3/legacypipe/py/runs/mzls_dr3/${SLURM_JOBID}${did_bcast}
...
export LEGACY_SURVEY_DIR=/scratch2/scratchdirs/kaylanb/dr3/desiproc-dr3-mzls-template
